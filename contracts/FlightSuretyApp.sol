...
contract FlightSuretyApp {
    ...
    */
                                ...
                                public 
    {
        ...
        registerAirline(genesisAirline, "Genesis airline");
    }
    ...
    */  
    function registerFlight
                                ...
                                requireIsOperational
    {
        bytes32 _flightKey = keccak256(abi.encodePacked(_airline, _timestamp, _flight));
    ...
    */  
    function processFlightStatus
                                ...
                                requireIsOperational
    {
        bytes32 _flightKey = keccak256(abi.encodePacked(airline, timestamp, flight));
        flights[_flightKey].statusCode = statusCode;
        if(flights[_flightKey].statusCode == STATUS_CODE_LATE_AIRLINE){
            dataContract.creditInsurees(_flightKey);
        }
        else{
            dataContract.closeInsurees(_flightKey);
        }
    }
